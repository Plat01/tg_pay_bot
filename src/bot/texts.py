...
class Texts:
    ...
    START_WELCOME = (
        ...
        "💸 Партнерская программа с пассивным доходом! и выводом на карту от 1000₽\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "📌 <b>Ваши подписки:</b>\n{subscription_status}\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
    ...
    PAY_TEXT = (
        ...
        "• 1 месяц | 1 устройство • 199 RUB\n"
        "• 3 месяца | 1 устройство • 499 RUB\n"
        "• 1 год | 1 устройство • 1999 RUB\n\n"
    ...
    BALANCE_INFO = (
        ...
        "💎 <b>{referral_percent}% от каждой покупки рефералов</b> поступает на ваш баланс!\n\n"
        "💡 <b>Пример:</b> Если реферал купит подписку на 1000 ₽, вы получите {example_bonus} ₽\n\n"
    ...
    REFERRAL_EARNING_NOTIFICATION = (
        "🎉 <b>Реферал оплатил подписку!</b>\n\n"
        "👤 {referral_name} (@{referral_username})\n"
        "💰 Сумма: {payment_amount} ₽\n"
        "🎁 Вам начислено: {bonus_percent}% ({bonus_amount} ₽)\n\n"
        "💡 Пример: если реферал купит подписку на 1000 ₽, вы получите {example_bonus} ₽\n\n"
    ...
    # Payment balance
    PAYMENT_BALANCE_INSUFFICIENT_FUNDS = (
        "❌ <b>Недостаточно средств на балансе</b>\n\n"
        "💰 Ваш баланс: {balance} ₽\n"
        "💳 Требуется: {required} ₽\n"
        "📊 Недостаточно: {missing} ₽\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "💡 <b>Как пополнить баланс:</b>\n\n"
        "• Нажмите кнопку <b>➕ Пополнить</b> ниже\n"
        "• Или используйте команду <code>/deposit {min_deposit}</code>\n"
        "   (минимальная сумма пополнения: {min_deposit} ₽)\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "Выберите другой способ оплаты или пополните баланс."
    )
    ...
    BALANCE_WITHDRAW_INFO = (
        "💰 <b>Вывод баланса</b>\n\n"
        "Для вывода средств на банковскую карту:\n"
        "1. Обратитесь в поддержку с текущего аккаунта\n"
        "2. Укажите сумму для вывода\n"
        "3. Предоставьте реквизиты карты\n\n"
        "⚠️ <b>Внимание:</b> Вывод занимает 1-3 рабочих дня.\n\n"
        "👇 Нажмите кнопку ниже для обращения в поддержку."
    )
